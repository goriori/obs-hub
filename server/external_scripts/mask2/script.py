...
def load_filter(filters_config, filter_name="leva"):
...
def process_frame(frame, args, source_type=None):
    ...
    filters_config = {
        'leva':
            [{'path': "assets/leva.png",
            'anno_path': "assets/leva_annotations.csv",
    ...
    filters, multi_filter_runtime = load_filter(filters_config,next(iter_filter_keys))
