...
face_cascade = cv2.CascadeClassifier(f'{relative_path_to_assets_folder}/haarcascade_frontalface_default.xml')

# Load the mask image
mask_image_path = f'{relative_path_to_assets_folder}/mask.png'  # Ensure this path points to the mask image
